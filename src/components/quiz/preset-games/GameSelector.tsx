...
const GameSelector: React.FC<GameSelectorProps> = ({ onSelectGame }) => {
  ...
  return (
    <div className="min-h-full w-full overflow-y-auto bg-white dark:bg-slate-900">
      <div className="flex flex-col items-center justify-start p-6 min-h-full">
        ...
        >
          ...
          <motion.div 
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 max-w-7xl mx-auto pb-8"
            variants={containerVariants}
          >
            {gameTypes.map((game, index) => (
              ...
              >
                ...
                >
                  <Card 
                    className={`p-7 cursor-pointer h-full group relative overflow-hidden ${
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center gap-5 h-full">
                      <motion.div 
                        className="p-4 bg-primary/10 rounded-full transition-all duration-300"
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-bold mb-3 transition-colors duration-300 group-hover:text-primary">{game.name}</h3>
