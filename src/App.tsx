...
const App = () => {
  useEffect(() => {
    ...
    const setupProxyHandler = () => {
      if (!(window as any).proxyInitialized) {
        (window as any).proxyInitialized = true;
    ...
    return () => {
      ...
      // We don't restore the original fetch as it could break other components that depend on our proxy
    };
  }, []);
